    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#e0f7fa] to-[#e3f2fd] p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        ...
        <form className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-400 to-cyan-500 hover:from-cyan-500 hover:to-blue-400 text-white font-semibold py-3 rounded-lg transition duration-300"
          >
            Create an account
          </button>
        </form>
